...
describe('the user colour palette', () => {
	...
	it('maps every colour to classes, and nothing else', () => {
	...
	it('renders a known colour with its own classes', () => {
...
describe('leastUsedColor', () => {
	it('picks the first palette colour for an empty instance', () => {
		expect(leastUsedColor([])).toBe('amber');
	});

	it('picks the one free colour', () => {
